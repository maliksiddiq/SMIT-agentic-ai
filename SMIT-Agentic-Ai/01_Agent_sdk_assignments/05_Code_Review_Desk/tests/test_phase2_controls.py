...
from src.guardrails.secret_guardrail import (
    credential_input_guardrail,
...
def test_credentials_use_native_agents_sdk_guardrails() -> None:
    assert type(credential_input_guardrail).__name__ == "InputGuardrail"
    assert type(credential_output_guardrail).__name__ == "OutputGuardrail"
